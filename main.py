...
def DrawGrid():
    ...
    # Drawing lines horizontally and vertically to form grid
    for i in range(10):
        if i % 3 == 0:
...
def DrawModes():
    ...
    screen.blit(TitleFont.render("Game Settings", True, (128, 0, 0)), (15, 505))
    screen.blit(AttributeFont.render("C: Clear", True, (0, 0, 0)), (30, 530))
    screen.blit(TitleFont.render("MODES", True, (128, 0, 0)), (15, 555))
    screen.blit(AttributeFont.render("E: Easy", True, (0, 0, 0)), (30, 580))
    screen.blit(AttributeFont.render("A: Medium", True, (0, 0, 0)), (30, 605))
